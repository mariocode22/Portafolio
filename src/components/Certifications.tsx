...
import { FileDown, ExternalLink, Calendar, Building, Sparkles } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-[#B8B8B8] text-base md:text-lg max-w-2xl">
            Credenciales profesionales que respaldan mi conocimiento técnico.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-[#1E1E1E]/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
            ...
            <div className="text-xs text-[#B8B8B8] uppercase tracking-wider font-semibold">Certificaciones</div>
          </div>
          <div className="bg-[#1E1E1E]/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
